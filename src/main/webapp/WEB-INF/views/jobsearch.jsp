...
<title>Search jobs | CarrerSearch.com</title>
...
<body id="pagetop">
		...
		<nav class="navbar navbar-inverse navbar-fixed-top">
			<div class="container-fluid">
				<div class="navbar-header">
					<a class="navbar-brand" href="/CarrerSearch">CarrerSearch.com</a>
				</div>
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							...
							<li><a href="CarrerSearch">Logout</a></li>
						</ul></li>
				</ul>
			</div>
		</nav>
    ...
    <p>${job.description}</p>
     -->
		...
		<h4> Please select here to send matched jobs:</h4><a class="a1" href="sendmatchedjobs?jobSeekerId=${seeker.jobseekerId}">Matched Jobs</a>
