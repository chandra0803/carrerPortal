...
CREATE TABLE `jobseeker` (
  ...
  `workEx`  VARCHAR(255)   NULL, 	
  `highestEducation`  VARCHAR(255)   NULL,
  `skills` TEXT  NULL,
...
INSERT INTO `jobposting` VALUES (2,1,1,'new','Updated','Do yourwork','Pune',1212140,'SE SE SE san Jose'),(2,1,0,'Test','66','234','San Jose',242,'Test 66 243 adfd'),(3,1,0,'Test','66','234','adfd',242,'Test 66 243 adfd');
...
INSERT INTO `jobpostingsview` VALUES (1,1,'mycompany','desc','java','Pune','Do yourwork','6 lakhs', 12, 'TL'),(2,1,'newcompany','desc','java','Noida','responsible','12 lakhs', 12, 'Tech Lead'),(3,1,'IBM','desc','java','Bangalore','responsible','8 lakhs', 12, 'Developer');
--
